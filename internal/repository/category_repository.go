...
import (
	...
	"github.com/nordicmanx/videos-api"
...
func (r *CategoryRepository) CreateCategory(ctx context.Context, name string) (*models.Category, error) {
	...
	query := `INSERT INTO categories (name) VALUES ($1) RETURNING id, created_at, updated-at`
...
func (r *CategoryRepository) GetAllCategories(ctx context.Context) ([]models.Category, error) {
	...
	query := `SELECT id, name, created_at, updated_at FROM categories ORDERBY name ASC`
